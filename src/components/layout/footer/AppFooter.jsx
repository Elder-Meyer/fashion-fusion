...
function Copyright() {
  return (
    <React.Fragment>
      {'© '}
      <Link color="inherit" component={LinkRoute} to="/inicio">
        Your Website
      </Link>{' '}
          ...
          <Grid item xs={6} sm={4} md={3}>
            ...
            >
              <Grid item sx={{ display: 'flex' }}>
                <Box component="a" target='_BLANK' href="https://facebook.com/" sx={iconStyle}>
                  <img
                    src={appFooterFacebook}
                    alt="Facebook"
                  />
                </Box>
                <Box component="a" target='_BLANK' href="https://twitter.com/" sx={iconStyle}>
                  <img
          ...
          <Grid item xs={6} sm={4} md={2}>
            ...
            <Box component="ul" sx={{ m: 0, listStyle: 'none', p: 0 }}>
              <Box component="li" sx={{ py: 0.5 }}>
                <Link component={LinkRoute} to="/terms">Terms</Link>
              </Box>
              <Box component="li" sx={{ py: 0.5 }}>
