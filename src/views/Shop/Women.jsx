...
import { tallas, colores, marcas, tipos } from "./optionListWomen"
...
const Women = () => {
  ...
  const obtenerInfo = async () => {
    ...
    const listMujer = docList.docs.filter((doc) => doc.data().categoria === 'mujer');
    setProyectos(listMujer);
    setDocs(listMujer);
    setTablaProyectos(listMujer);
  }
  ...
  const handleSearch = async () => {
    try {
      ...
      let query = collectionRef.where('categoria', '==', 'mujer');
  ...
  return (
    <WrapperSingleRoute>
      <Grid container>
        ...
        <Grid item xs={12}>
          <Bread migas={[{ miga: "INICIO", ruta: "/inicio", icono: <HomeIcon/> }, { miga: "TIENDA", ruta: "/tienda", icono: <StoreIcon/> }, { miga: "MUJER", ruta: "/tienda/mujer", icono: <WomanIcon/> }]} />
        </Grid>
      </Grid>
