...
import { tallas, colores, marcas, tipos } from "./optionListNiño"
...
function Child() {
  ...
  const obtenerInfo = async () => {
    ...
    const listHombre = docList.docs.filter((doc) => doc.data().categoria === 'niño');
  ...
  const handleSearch = async () => {
    try {
      ...
      let query = collectionRef.where('categoria', '==', 'niño');
  ...
  return (
    <WrapperSingleRoute>
      <Grid container>
        ...
        <Grid item xs={12}>
          <Bread migas={[{ miga: "INICIO", ruta: "/inicio", icono: <HomeIcon/> }, { miga: "TIENDA", ruta: "/tienda", icono: <StoreIcon/> }, { miga: "NIÑO", ruta: "/tienda/niño", icono: <ManIcon/> }]} />
        </Grid>
      </Grid>
